...
func _rebuild_visual_stage() -> void:
	InteriorStageBuilderScript.rebuild(self, {
		...
		"items": [
			...
			{"kind": "line", "name": "CeilingFanSlot", "from": Vector2(334, 62), "to": Vector2(414, 62), "width": 3.0, "color": Color(0.32, 0.26, 0.2, 0.72), "z": -71},
			...
			{"kind": "line", "name": "CeilingSmokeSeam", "from": Vector2(44, 76), "to": Vector2(706, 76), "width": 2.0, "color": Color(0.11, 0.08, 0.06, 0.45), "z": -39},
