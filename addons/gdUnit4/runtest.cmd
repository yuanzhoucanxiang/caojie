...
:: Godot 4.6.2 rejects the old remote-debug port 0 workaround, so use headless mode.
"!godot_binary!" --headless --path . -s res://addons/gdUnit4/bin/GdUnitCmdTool.gd !filtered_args!
