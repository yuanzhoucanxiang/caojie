...
所有室内共享同一套天花板高度（25px）、地面线（y=340）、墙壁厚度（15px）、地板高度（y=340~480）。区别只有屏幕宽度和 zoom：1F 最宽（750px, zoom=1.8），2F 窄（640px, zoom=1.8），3F 最窄（510px, zoom=2.0）。房间越小，镜头越近，玩家感受到的私密感越强。宽度决定"有多少可探索内容"，zoom 决定"有多亲密"。
